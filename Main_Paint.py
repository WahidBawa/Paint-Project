...
tmp1_pic = image.load("PICS/000.png").convert_alpha()
tmp2 = Rect(1035,425,115,115)
tmp2_pic = image.load("PICS/000.png").convert_alpha()
tmp3 = Rect(1165,425,115,115)
tmp3_pic = image.load("PICS/000.png").convert_alpha()
tmp4 = Rect(1035,175,115,115)
tmp4_pic = image.load("PICS/000.png").convert_alpha()
tmp5 = Rect(1165,175,115,115)
tmp5_pic = image.load("PICS/000.png").convert_alpha()
tmp6 = Rect(1035,296,115,115)
tmp6_pic = image.load("PICS/000.png").convert_alpha()
